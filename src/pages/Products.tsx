        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl font-bold mb-6">
              Our{" "}
              <span className="bg-gradient-hero bg-clip-text text-semolina">
                Premium Products
              </span>
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Badge className="px-4 py-2 bg-semolina text-black">
                100g Packs
              </Badge>
              <Badge className="px-4 py-2 bg-semolina text-black">
                200g Packs
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map((product, index) => (
              <Card
                key={index}
                className="p-6 shadow-card hover:shadow-warm transition-shadow"
              >
                ...
                <div className="space-y-2 mb-4">
                  {product.sizes.map((size, idx) => (
                    ...
                    >
                      ...
                      <span className="font-semibold text-pasta-gold">
                        {size.split(" - ")[1]}
                      </span>
                    </div>
                  ))}
                ...
                <Button
                  className="w-full bg-semolina hover:opacity-90"
                  asChild
                >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Every pack goes through rigorous quality checks to ensure you get
              the best
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {wholesaleDeals.map((deal, index) => (
              ...
              >
                ...
                <div className="text-3xl font-bold text-pasta-gold mb-2">
                  {deal.price}
                </div>
                <Badge className="mb-4 bg-pasta-green">{deal.savings}</Badge>
                <Button
                  className="w-full text-black bg-semolina hover:opacity-90"
                  asChild
                >
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Get your premium pasta delivered quickly with our reliable supply
            chain
          </p>
